...
{
private:
  int  tBitLen; // длина битового поля - макс. к-во битов
  TELEM *pMem; // память для представления битового поля
  int  tMemLen; // к-во эл-тов Мем для представления бит.поля
...
//   бит.поле - набор битов с номерами от 0 до tBitLen
//   массив pМем рассматривается как последовательность tMemLen элементов
